...
async function main() {
  ...
  const sheet = workbook.Sheets['Categorias Digitales'];
  ...
  XLSX.writeFile(newWorkbook, 'resultados categorias digitales.xlsx');
 
  console.log(`
    Proceso completado:
    - Archivo generado: resultados categorias digitales.xlsx
    - Matches: ${filasConPriceIndex}
